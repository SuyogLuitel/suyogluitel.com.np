  ...
  return (
    <div className="container px-4 md:px-6 py-12 animate-fade-in">
      <div className="space-y-8">
        ...
        {/* Contact Info + Form */}
        <section className="grid md:grid-cols-[1fr_2fr] gap-8 lg:gap-12">
          {/* Contact Info */}
          <div className="space-y-6">
            ...
            <div className="bg-card p-6 rounded-lg border border-border/50 animate-slide-up animation-delay-100">
              <div className="flex items-start">
                <div className="mr-4 p-2 bg-secondary rounded-md">
            ...
            <div className="bg-card p-6 rounded-lg border border-border/50 animate-slide-up animation-delay-200">
              <div className="flex items-start">
                <div className="mr-4 p-2 bg-secondary rounded-md">
            ...
            <div className="p-6 rounded-lg bg-secondary/50 animate-slide-up animation-delay-300">
